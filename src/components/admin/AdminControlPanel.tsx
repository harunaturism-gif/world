...
export function AdminControlPanel({ adminSession, layoutVersion, onAuthorizationLost, onClose, onEnterRoom, onLayoutVersionChange, room, selectedObjectId, onRoomChange, onSelectedObjectIdChange }: Props) {
