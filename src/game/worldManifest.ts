...
export const centralPlazaRoom: RoomDefinition = {
  ...
  contextObjects: [
    { id: 'north-cafe-facade', asset: '/assets/world/buildings/cafe.png', category: 'building', position: { x: -13.4, y: -7.4 }, displayWidth: 330, anchor: { x: .5, y: 1 }, depthBase: { x: -13.4, y: -7.1 }, depthBias: -2 },
    { id: 'north-tree-a', asset: '/assets/world/vegetation/tree.png', category: 'vegetation', position: { x: -10.5, y: -8.5 }, displayWidth: 170, anchor: { x: .5, y: 1 }, depthBase: { x: -10.5, y: -8.5 } },
    { id: 'north-tree-b', asset: '/assets/world/vegetation/tree.png', category: 'vegetation', position: { x: 11.8, y: -8.1 }, displayWidth: 165, anchor: { x: .5, y: 1 }, depthBase: { x: 11.8, y: -8.1 } },
    { id: 'west-tree-a', asset: '/assets/world/vegetation/tree.png', category: 'vegetation', position: { x: -13.2, y: 1.2 }, displayWidth: 170, anchor: { x: .5, y: 1 }, depthBase: { x: -13.2, y: 1.2 } },
    { id: 'east-tree-a', asset: '/assets/world/vegetation/tree.png', category: 'vegetation', position: { x: 12.6, y: 3.5 }, displayWidth: 174, anchor: { x: .5, y: 1 }, depthBase: { x: 12.6, y: 3.5 } },
    { id: 'south-tree-a', asset: '/assets/world/vegetation/tree.png', category: 'vegetation', position: { x: -7.5, y: 10.6 }, displayWidth: 160, anchor: { x: .5, y: 1 }, depthBase: { x: -7.5, y: 10.6 } },
    { id: 'south-tree-b', asset: '/assets/world/vegetation/tree.png', category: 'vegetation', position: { x: 8.7, y: 10.4 }, displayWidth: 160, anchor: { x: .5, y: 1 }, depthBase: { x: 8.7, y: 10.4 } },
  ],
  objects: [
